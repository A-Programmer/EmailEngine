...
{
    private Email(string recipient, string subject, string body, bool isHtmlBody, List<EmailAttachment>? attachments)
    {
    ...
    public static Email Create(string receiver, string subject, string body, bool isHtmlBody, List<EmailAttachment>? attachments)
    {
        return new Email(receiver, subject, body, isHtmlBody, attachments);
    }
}